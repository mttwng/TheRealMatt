...
?>
	...
	<p>A resume is required as part of your application. Please also include your full name as the title of your resume. We will take into account your ability to follow instructions properly.<br /><br /><label for="attachment">(1 file only, max file size 1024kb. Allowed file formats are .doc, .pdf, .zip, .rar)</label>
