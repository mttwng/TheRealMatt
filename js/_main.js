...
( function( $ ) {
	...
	$body.imagesLoaded( function() {
		setTimeout(function() {
			  ...
			  if (winW < 768) {
			  	$( "#secondary" ).empty();
			  	$( "#add_me" ).append("<a href='https://www.linkedin.com/in/mttwng' style='color:#1478bb' target='_blank'>Linkedin</a><br><a href='mailto:therealmattwong@gmail.com' style='color:#1478bb' target='_blank'>therealmattwong@gmail.com</a>");
			  }
